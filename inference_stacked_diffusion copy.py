...
cfg['save_dir'] = './output/StackedDiff2'#'./output/sample'#'./output'
cfg['ip_dir'] = './dataset'
cfg['json_file'] =  'dataset_250.json'#'sample_data.json'# 'dataset_processed.json'
...
for task_id, task_details in tasks_data.items():
    ...
    step_texts = task_details["steps_generated"]
